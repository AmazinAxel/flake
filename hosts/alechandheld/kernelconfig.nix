{ lib, ...}: {
  boot.kernelPatches = [{
    ...
    structuredExtraConfig = with lib.kernel; {
      ...
      RELAY = yes;
      BLK_DEV_INITRD = yes;
      INITRAMFS_SOURCE = freeform "@INITRAMFS_SOURCE@";
      INITRAMFS_ROOT_UID = freeform "0";
      INITRAMFS_ROOT_GID = freeform "0";
      RD_GZIP = yes;
      RD_BZIP2 = yes;
      RD_LZMA = yes;
      RD_XZ = yes;
      ...
      "64BIT" = yes;
      MMU = yes;
      ARM64_CONT_PTE_SHIFT = freeform "4";
      ARM64_CONT_PMD_SHIFT = freeform "4";
      ...
      TRANS_TABLE = yes;
      ARCH_FORCE_MAX_ORDER = freeform "10";
      ...
      LSM = freeform "landlock,lockdown,yama,loadpin,safesetid,bpf";
