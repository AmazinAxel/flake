/* Minimal libretro "core" that turns RetroArch playlist entries into launch
 * requests: loading a .launch file writes its basename to /tmp/launch-request
 * and asks RetroArch to shut down.  The game-launcher session script (see
 * menus.nix) watches for the file, kills RetroArch and runs the real program.
 */
#include <stdio.h>
#include <string.h>
#include <libgen.h>
